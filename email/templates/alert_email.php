                ...
                <table bgcolor="#ffffff" width="100%" style="max-width: 640px; padding: 40px; border: 1px solid #e0e0e0;" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td style="padding: 0 40px;">
                            <h1 style="font-size: 24px; color: #2F1C6A; margin: 30px 0 15px;">🚨 Price Alert!</h1>
                            ...
                            <p style="font-size: 16px; color: #333; margin: 10px 0;">Previous Price: ₹{{previous_price}}</p>
                            <p style="font-size: 16px; color: #333; margin: 10px 0;">Current Price: ₹{{current_price}} ({{change}}% {{direction}})</p>
                    ...
                    <tr>
                        <td style="padding: 40px 40px 0;">
                            ...
                            <p style="font-size: 13px; color: #555; margin: 10px 0;">
                                You're getting this email because you're tracking {{name}} on AmezPrice! Here's the latest price update.
                            </p>
