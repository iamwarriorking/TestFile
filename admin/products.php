...
$perPage = 50; // Changed to match user favorites page
...
<head>
    ...
    <style>
        /* User/favorites page styled design for admin products */
        .product-name-cell {
            max-width: 300px;
            position: relative;
        }
        ...
        /* Admin table styling to match user table exactly */
        .admin-table {
            background: #FFFFFF;
            border-radius: 8px;
            overflow: hidden;
...
<body>
    ...
    <div class="admin-container">
        ...
        <div class="admin-content">
            <h1>Products</h1>
            <p style="color: #666; margin-bottom: 24px;">Manage all products in the system. View tracking statistics and product details.</p>
            
            <?php if (empty($products)): ?>
                <div class="card" style="text-align: center; padding: 48px;">
                    <i class="fas fa-box" style="font-size: 48px; color: #ccc; margin-bottom: 16px;"></i>
                    <h3 style="color: #666; margin-bottom: 16px;">No Products Found</h3>
                    <p style="color: #999;">No products are currently available in the system.</p>
                </div>
            <?php else: ?>
                <!-- Search Actions - Separate from table (like bulk actions in favorites) -->
                <div class="search-actions" id="admin-search-container">
                    <i class="fas fa-search"></i>
                    <input type="text" id="admin-table-search" placeholder="Search products by name or price" aria-label="Search products">
                </div>
                ...
                <div class="pagination" style="text-align: center; margin-top: 24px;">
                    ...
                    <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                        <a href="/admin/products.php?page=<?php echo $i; ?>" 
