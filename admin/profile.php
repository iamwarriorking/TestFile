...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'update_profile') {
        ...
        if ($email !== $admin['email'] && !$otp) {
            ...
            file_put_contents('../logs/admin.log', "[" . date('Y-m-d H:i:s') . "] OTP sent to $email for profile update\n", FILE_APPEND);
        ...
        file_put_contents('../logs/admin.log', "[" . date('Y-m-d H:i:s') . "] Profile updated for admin ID $adminId\n", FILE_APPEND);
    ...
    if ($action === 'update_password') {
        ...
        if (!$otp) {
            ...
            file_put_contents('../logs/admin.log', "[" . date('Y-m-d H:i:s') . "] OTP sent to {$admin['email']} for password change\n", FILE_APPEND);
        ...
        file_put_contents('../logs/admin.log', "[" . date('Y-m-d H:i:s') . "] Password updated for admin ID $adminId\n", FILE_APPEND);
